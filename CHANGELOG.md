...
Automated patch release. See the [full diff](https://github.com/antitree/meshhermes/compare/v1.0.6...v1.0.7) for the changes this rolls up.
...
[Unreleased]: https://github.com/antitree/meshhermes/compare/v1.0.7...HEAD
